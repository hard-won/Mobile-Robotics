...
def generate_launch_description():
    ...
    gazebo_client = launch.actions.IncludeLaunchDescription(
        launch.launch_description_sources.PythonLaunchDescriptionSource(
            os.path.join(gazebo_ros, 'launch', 'gzclient.launch.py')), condition=launch.conditions.
        IfCondition(launch.substitutions.LaunchConfiguration('gui')))
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('tutorial_pkg',
                              default_value=[EnvironmentVariable('USER'), '_'], description='tutorial_pkg_node'),
        Node(package='tutorial_pkg', executable='tutorial_pkg_node', output='screen',
             name=[LaunchConfiguration('tutorial_pkg'), 'tutorial_pkg_node']),
        gazebo_server,
        gazebo_client,
        spawn_rosbot,
    ])
